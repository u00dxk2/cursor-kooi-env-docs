...
> ⚠️ **Note:** This is a TEMPLATE file. The actual `project-environment.md` should be generated by your AI assistant using the prompt in `quick-prompt.txt`. This file shows the expected structure and format.
